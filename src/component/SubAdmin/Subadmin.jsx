...
import { subAdmindata } from '../../dummydata/DummyData'
                    ...
                    return <div className="userList"  >
                            ...
                            <div>
                                <div className="tournament-type" >
                                    ...
                                    <div className='' style={{ padding: "0.5rem 1rem " }}>
                                        <h5 style={{ fontWeight: 900, color: '#3F4254', marginBottom: 0 }}>₹{persondata?.earning}</h5>
                                        <p className="span-text-light" style={{ fontSize: 13, marginBottom: 0 }}>Total Earning </p>

                                    </div>
                                    <div className='' style={{ padding: "0.5rem 1rem " }}>
                                        <h5 style={{ fontWeight: 900, color: '#3F4254', marginBottom: 0 }}>{persondata?.followers}</h5>
                                        <p className="span-text-light" style={{ fontSize: 13, marginBottom: 0 }}>Followers</p>
                                    </div>
                                    <div className='' style={{ padding: "0.5rem 1rem " }}>
                                        <h5 style={{ fontWeight: 900, color: '#3F4254', marginBottom: 0 }}>{persondata?.following}</h5>
                        ...
                        <div className="d-flex flex-column justify-content-between" >
                            <div style={{ display: 'flex', gridGap: 10, height: 'fit-content', justifyContent: 'flex-end' }}>
                                ...
                                <button className="themeButton" onClick={() => navigate('/Usersdetails/20')}>Edit</button>
