...
<div style={{flex:1}}>
<h6  style={{marginBottom:10,fontWeight:600,color:'#3F4254'}}>Rahul Kumar

<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginLeft:12}}>
...
<span className='span-box' style={{background:'#F8F5FF',color:'#5014D0',marginLeft:10}}>Pro user</span>
</h6>
...
<div>
            ...
            <div>
                <h5 style={{fontWeight:900,color:'#3F4254',marginBottom:0}}>179</h5>
                <p className="span-text-light" style={{fontSize:13,marginBottom:0}}>Followers</p>
            </div>
            <div>
                <h5 style={{fontWeight:900,color:'#3F4254',marginBottom:0}}>82</h5>
...
<div className="userDetails-tabs "  style={{borderRadius:'0 0 12px 12px'}}>
    ...
    <span style={tab==6 ? {color:'#00A3FF',borderBottom: '3px solid #00A3FF'}:{color:'#A1A5B7'}} onClick={()=>setTab(6)}>Join Match List</span>
    <span style={tab==7 ? {color:'#00A3FF',borderBottom: '3px solid #00A3FF'}:{color:'#A1A5B7'}} onClick={()=>setTab(7)}>Match History</span>
...
{tab==2 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab2 /></motion.div>)}
{tab==3 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab3 /></motion.div>)}

{tab==4 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab4 /></motion.div>)}

{tab==5 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab5 /></motion.div>)}
{tab==6 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab6 /></motion.div>)}

{tab==7 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab7 /></motion.div>)}
{tab==8 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab8 /></motion.div>)}

{tab==9 && ( <motion.div  initial={{x:-200}} animate={{ x: 0 }} ><Tab9 /></motion.div>)}
