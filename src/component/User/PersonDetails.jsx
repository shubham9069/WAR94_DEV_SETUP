...
const PersonDetails = ({ persondata, deleteuser }) => {
  const navigate = useNavigate()
  return (
    <>
      <div className="userList"  >
        <img src={persondata?.avatar} style={{ width: 170, height: 170, borderRadius: 6 }}></img>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div className="tournament-type" >
            ...
            <div>
              <h5 style={{ fontWeight: 900, color: '#3F4254', marginBottom: 0 }}>₹{persondata?.winning}</h5>
        ...
        <div className="d-flex flex-column justify-content-between" >
          <div style={{ display: 'flex', gridGap: 10, height: 'fit-content', justifyContent: 'flex-end' }}>
            <button className="themeButton" style={{ backgroundColor: '#F4F4F4', color: ' #A1A5B7', borderColor: '#F4F4F4' }} onClick={() => deleteuser(persondata?.id)}>Delete</button>
