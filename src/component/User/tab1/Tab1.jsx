...
<div className='tab1-right w-100'>
    ...
    <span className="span-box" style={{color:'#00A3FF'}}>In Progress</span>
    <span className="span-box" style={{color:'#A1A5B7',background:'#F5F8FA',marginLeft:18}}>View</span>
    </div>
    <div className='center-div tab1-right-div '>
    <h6 style={{flex:1,marginBottom:0,fontWeight:600}}>Free Fire</h6>
    <span className="span-box" style={{color:'#A1A5B7',background:'#F5F8FA'}}>22-09-2022  09:30 AM</span>
    <span className="span-box" style={{color:'#50CD89',background:'#E8FFF3'}}>joined</span>
    <span className="span-box" style={{color:'#A1A5B7',background:'#F5F8FA',marginLeft:18}}>View</span>
    </div>
</div>
