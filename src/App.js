...
<Route path="/UpComming-match" element={<Tournament_page status={0}/>} />
...
<Route path="/report-user" element={<Report URL={"/get_reports"}/>} />
...
<Route path="/pending-spotlight" element={<Spotlight/>} />
